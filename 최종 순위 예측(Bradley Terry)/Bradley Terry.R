library(dplyr)
ex_win_bt<- data.frame(team = c( 'SSG', 'LG',  'KT', 'KW', 'KIA', 'LT', 'NC', 'DB', 'SL', 'HW'),
...
ex_win_bt %>% arrange(desc(pythago))         

write.csv(ex_win_bt, file = 'C:/Users/jaeb0/Desktop/ex_win_bt.csv')

library(readxl)
result <- read_excel('C:/Users/jaeb0/Desktop/ex_win_bt.xlsx', sheet= 2)
